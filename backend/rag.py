...
def retriever_tool(question: str)->str:
    '''
    Performs RAG on the database of loans and returns the final llm generated response
    Input: question/instruction from react agent
    Output: Reponse to the input after RAG
